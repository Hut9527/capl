						...
						<div class="box-body table-responsive">
							<table id="example2" class="table table-bordered text-center">
								...
								<input type="hidden" name="id" value="${person.id }">
									<td><input type="checkbox" name="check" value="${person.id }"></td>
					...
					<form action="" id="form" method="post">
	                   ...
	                   <div class="col-xs-6 choice">
						...
						<ul class="col-xs-12 eletcadd">
							...
							<button type="button"  style="margin-left:50px;"  onclick="quxiao()" class="btn btn-danger btn-lg"><i class="fa fa-fw fa-times"></i> 取 消</button>
						</ul>
					</form>
				</div>
			</div>

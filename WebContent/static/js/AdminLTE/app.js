...
/*    $("#icon").leoweather({format:'<img src="/capl/static/img/weather/{图标}.gif"/>'});
  ...
  /*  //点击添加按钮弹出
    ...
    function _fix() {
        ...
        if (content > height)
            ...
            $(".left-side, html, body").css("min-height", height +15+ "px");
        }
    }
    //Fire upon load
    _fix();
...
(function($) {
    ...
    $.fn.tree = function() {
        ...
        return this.each(function() {
            ...
            var noce=$(this).siblings().children(".treeview-menu").children("li");
            ...
            noce.on('click',function(){
                $(this).addClass('cliove').siblings().removeClass('cliove');
           })
